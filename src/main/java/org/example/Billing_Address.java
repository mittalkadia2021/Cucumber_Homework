  ...
  // private By _countryName=By.cssSelector("//select[contains(@data-trigger, \"country-select\")]");
   ...
   private By _click_On_Continue=By.xpath("(//button[contains(text(), 'Continue')])[1]");
    ...
    public void enter_Shipping_Address_Details(){
         //expected result
        String Expected_Billing_url = "https://demo.nopcommerce.com/onepagecheckout#opc-billing";
        //actual result
        String Actual_Billing_url = driver.getCurrentUrl();
        //verify actual result and expected result
        Assert.assertEquals(Actual_Billing_url,Expected_Billing_url,"Billing page is not open");
        //print output
